...
export default function ScheduleGenerateActions({ tournamentId }: Props) {
  ...
  const handleRegenerate = () => {
    ...
    startTransition(async () => {
      const result = await regenerateScheduleBoardAction(tournamentId, {
        startTime,
        matchDurationMinutes: matchValue,
        breakDurationMinutes: breakValue,
      });
      ...
      setMessage({ tone: "success", text: "스케줄이 재생성되었습니다." });
      router.refresh();
    });
  };
